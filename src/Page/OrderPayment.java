...
public class OrderPayment {
    public static void payByBankWire() {
        //Log
        System.out.println(Utils.LogCreator.time() + "Choosing Pay by bank wire option");
        //Page Element
    ...
    public static void payByCheck() {
        //Log
        System.out.println(Utils.LogCreator.time() + "Choosing Pay by check option");
        //Page Element
    ...
    public static void printOrderSummary() {
        //Log
        System.out.println(Utils.LogCreator.time() + "Getting order price..");
        //Page Element
...
//        WebElement totalWithoutTax = Main.driver.findElement(By.id("total_price_without_tax"));
        ...
        //Action
        System.out.println(Utils.LogCreator.time() + "Order summary: \n Total Products: " + products.getText() +
